...
export default function About() {
  return (
    <section id="about" className="text-dynamic-black pb-20 sm:px-[3vw] md:pt-20">
      <div className="mt-6 mb-16 grid grid-cols-1 gap-y-6 md:grid-cols-4">
      ...
      <div className="grid grid-cols-1 gap-y-8 px-3 sm:px-0 md:grid-cols-4 lg:grid-cols-5">
        <ul className="grid grid-cols-1 md:col-span-3 md:grid-cols-3 md:gap-x-4 lg:gap-x-12">
          <li className="border-t-dynamic-black/80 grid grid-cols-3 gap-x-8 border-t py-4 md:grid md:grid-cols-1 md:grid-rows-[minmax(50px,max-content),min-content] md:gap-y-4 md:border-t-0">
        ...
        <div className="md:self-end md:justify-self-end lg:col-span-2">
          <CursorHover message="Scroll" scaleSize={4}>
            <a
              href="#work"
              className="border-dynamic-black flex items-center justify-center gap-x-2 rounded-full border px-5 py-2 text-xs whitespace-nowrap uppercase"
            >
              Explore my work
