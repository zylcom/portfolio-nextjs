  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Hi there, I am Sabilillah, a Web Developer from Jakarta, Indonesia."
        />
      ...
      <main className="bg-zhen-zhu-bai-pearl">
        ...
        <div className="px-4 mt-32 md:px-8">
            ...
            <ul className="grid grid-cols-1 md:col-span-2 md:grid-cols-3 md:gap-x-4 lg:gap-x-12">
              <li className="border-t border-t-dynamic-black/80 py-4 grid grid-cols-3 gap-x-8 md:py-0 md:border-t-0 md:grid md:grid-cols-1 md:grid-rows-[minmax(50px,max-content),min-content] md:gap-y-4">
                ...
                <p className="text-xs font-light col-span-2 md:text-sm md:font-normal">
                  I always strive to create responsive layouts experiences.
                  Users can access from different device without any problem
              ...
              <li className="border-t border-t-dynamic-black/80 py-4 grid grid-cols-3 gap-x-8 md:py-0 md:border-t-0 md:grid md:grid-cols-1 md:grid-rows-[minmax(50px,max-content),min-content] md:gap-y-4">
                ...
                <p className="text-xs font-light col-span-2 md:text-sm md:font-normal">
                  As an expert Developer, I make sure my code are clean,
          ...
          <div className="grid grid-cols-1 auto-rows-min gap-x-4 border-t border-t-dynamic-black/50 py-4 md:py-8 md:grid-cols-3">
            <span className="col-span-1 text-xs h-max w-max rounded-full border border-dynamic-black/40 mb-10 text-dynamic-black/40 py-1 px-4">
              Education
            </span>
            ...
            <div className="col-span-2 flex justify-between gap-x-4">
              <div className="flex flex-col gap-y-1">
                ...
                <span className="text-sm -tracking-wide">
                  Vocational High School 42 Jakarta
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 auto-rows-min gap-x-4 border-t border-t-dynamic-black/50 py-4 md:py-8 md:grid-cols-3">
            <span className="text-xs h-max w-max rounded-full border border-dynamic-black/40 mb-10 text-dynamic-black/40 py-1 px-4 md:col-span-1">
              Skills
            </span>
